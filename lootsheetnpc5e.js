...
Hooks.once("init", () => {
    ...
    async function transaction(seller, buyer, itemId, quantity) {
        ...
        const compensationCurrency = {"pp": "gp", "gp": "sp", "gp": "sp", "sp": "cp"};
        ...
        // console.log(`conversionRates["sp"] : ${conversionRates["sp"]}`);
        
        let buyerFundsAsPlatinum = buyerFunds["pp"];
        buyerFundsAsPlatinum += buyerFunds["gp"] / conversionRates["gp"];
        buyerFundsAsPlatinum += buyerFunds["sp"] / conversionRates["gp"] / conversionRates["sp"];
        buyerFundsAsPlatinum += buyerFunds["cp"] / conversionRates["gp"] / conversionRates["sp"] / conversionRates["cp"];
